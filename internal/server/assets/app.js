...
class App {
    ...
    openProviderEdit(providerId) {
        ...
        document.getElementById('provider-edit-transliteration').checked = provider.transliteration;
        ...
        if (['opentts', 'rhvoice', 'silero', 'openvoice', 'piper'].includes(provider.id)) {
    ...
    async saveProviderEdit() {
        ...
        const updateData = {
            ...
            transliteration: document.getElementById('provider-edit-transliteration').checked,
